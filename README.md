...
==================
    ...
    62-270  installation and configuration
    272-289 testing (pylint and pytest/coverage)
    291-298 closing notes
...
================================
    ...
    ----------------
        ...
        -------------------------------------------------------------
        NOTE: lines 201-205, 249-256 should be generated by certbot
            server {
